$(document).ready(function(){
	...
	$('#checkboxThreeInput').click(function(){
		...
		if(checkboxThreeInput) {
			$('#checkboxThreeInput_label').html('Om Ja, sedan vilket datum?');
		} else {
			$('#checkboxThreeInput_label').html('Om Nej, när ska ni flytta ihop?');
		}
	}); 
...
function prefillReview() { 
	...
	if($('#checkboxThreeInput').is(":checked")) $('#review_cohabiting').html('JA');
	else $('#review_cohabiting').html('NEJ');

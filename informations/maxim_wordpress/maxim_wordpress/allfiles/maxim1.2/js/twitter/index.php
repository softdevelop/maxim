...
$twitter_app_consumer_key = ot_get_option('consumer_key');
$twitter_app_consumer_secret = ot_get_option('consumer_secret');
$twitter_app_user_token = ot_get_option('user_token');
$twitter_app_user_secret = ot_get_option('user_secret');
